 ...
 */
function xoops_module_pre_install_latestnews(\XoopsModule $module)
{
    include __DIR__ . '/../preloads/autoloader.php';
    /** @var \Utility $utility */
    $utility = new \XoopsModules\Latestnews\Utility();
 ...
 */
function xoops_module_install_latestnews(\XoopsModule $module)
{
