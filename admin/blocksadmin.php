...
if ('list' === $op) {
    ...
    if (file_exists(XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/admin/blocksadmin.php')) {
        ...
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin/blocksadmin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin/groups.php';
    }
    ...
    foreach ($block_arr as $i) {
        ...
        echo "<tr valign='top'><td class='$class' align='center'><input type='text' name='title["
           . $i->getVar('bid') . "]' value='{$title}'></td><td class='{$class}' align='center' nowrap='nowrap'>\n"
           . "<div align='center'>\n"
           ...
           . "</div>\n"
           . "</td><td class='$class' align='center'>\n"
           . "<input type='text' name='weight[" . $i->getVar('bid') . "]' value='" . $i->getVar('weight') . "' size='5' maxlength='5'>\n"
           . "</td><td class='$class' align='center' nowrap><input type='radio' name='visible[" . $i->getVar('bid') . "]' value='1'$sel1>" . _YES . "&nbsp;"
        ...
        // Cache lifetime
        echo "<td class='{$class}' align='center'> <select name='bcachetime[" . $i->getVar('bid') . "]' size='1'>" . $cachetime_options . "</select></td>";

        // Actions
        echo "<td class='{$class}' align='center'>\n"
           . "<a href='blocksadmin.php?op=edit&amp;bid=" . $i->getVar('bid') . "'>"
    ...
    echo
        "<tr><td class='foot' align='center' colspan='8'>
...
if ('clone' === $op) {
    ...
    if (file_exists(XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/admin/blocksadmin.php')) {
        require_once XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/admin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/admin/blocksadmin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/admin/groups.php';
    } else {
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin/blocksadmin.php';
        require_once XOOPS_ROOT_PATH . '/modules/system/language/english/admin/groups.php';
...
if ('clone_ok' === $op) {
    ...
    if (empty($bmodule)) {
        xoops_cp_header();
        xoops_error(sprintf(_AM_NOTSELNG, _AM_LATESTNEWS_VISIBLEIN));
        xoops_cp_footer();
        exit();
    }
